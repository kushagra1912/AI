...
def transfer(currCap, no1, no2):
    ...
    if no1 == 1 and currCap[0] < maxCap[0]:
        if no2 == 2 and currCap[1] != 0:
            ...
            if diff > 0 and currCap[0] + diff < maxCap[0] and (currCap[1] - diff) >= 0:
                currCap[1] = currCap[1] - diff
                currCap[0] = currCap[0] + diff
            
        if no2 == 3 and currCap[2] != 0:
            diff = currCap[2] - currCap[0]
            if diff > 0 and currCap[0] + diff < maxCap[0] and (currCap[2] - diff) >= 0:
                currCap[2] = currCap[2] - diff
                currCap[0] = currCap[0] + diff        

    if no1 == 2 and currCap[1] < maxCap[1]:
        if no2 == 1 and currCap[0] != 0:
            diff = currCap[0] - currCap[1]
            if diff > 0 and currCap[1] + diff < maxCap[1] and (currCap[0] - diff) >= 0:
                currCap[0] = currCap[0] - diff
                currCap[1] = currCap[1] + diff
            else:
                currCap[1] = maxCap[1]
                currCap[0] = currCap[0] - maxCap[1]
        if no2 == 3 and currCap[2] != 0:
            diff = currCap[2] - currCap[1]
            if diff > 0 and currCap[1] + diff < maxCap[1] and (currCap[2] - diff) >= 0:
                currCap[2] = currCap[2] - diff
                currCap[1] = currCap[1] + diff
            else:
                currCap[1] = maxCap[1]
                currCap[2] = currCap[2] - maxCap[1]

    if no1 == 3 and currCap[2] < maxCap[2]:
        if no2 == 1 and currCap[0] != 0:
            diff = currCap[0] - currCap[2]
            if diff > 0 and currCap[2] + diff < maxCap[1] and (currCap[0] - diff) >= 0:
                currCap[0] = currCap[0] - diff
                currCap[2] = currCap[2] + diff
            else:
                currCap[2] = maxCap[2]
                currCap[0] = currCap[0] - maxCap[2]
        if no2 == 2 and currCap[1] != 0:
            diff = currCap[1] - currCap[2]
            if diff > 0 and currCap[2] + diff < maxCap[2] and (currCap[1] - diff) >= 0:
                currCap[1] = currCap[1] - diff
                currCap[2] = currCap[2] + diff
            else:
                currCap[2] = maxCap[2]
                currCap[1] = currCap[1] - maxCap[2]
    line(currCap)
    return currCap
